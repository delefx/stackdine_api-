  ...
  try {
    ...
    try {
      ...
      await sendEmail({
        ...
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;background:#0f172a;color:#fff"><h1 style="color:#f97316">StackDine</h1><p style="color:#9ca3af">Restaurant Management System</p><h2>Hi ${user.name}, your order has been placed!</h2><p style="color:#d1d5db">Your order of <strong style="color:#f97316">₦${totalAmount.toLocaleString()}</strong> is being processed.</p></div>`,
      });
    } catch (emailErr) {
